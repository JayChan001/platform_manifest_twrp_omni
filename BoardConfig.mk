...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := SRPTD21A002

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 86888448 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/samsung/gts7xlwifi
TARGET_KERNEL_CONFIG := gts7xlwifi_defconfig
